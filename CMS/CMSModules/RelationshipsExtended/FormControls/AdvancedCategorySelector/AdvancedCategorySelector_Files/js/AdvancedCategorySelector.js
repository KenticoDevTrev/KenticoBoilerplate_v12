...
// Gets the containing div, this way the javascript is limited to it's own form field and 
// won't affect other form fields with this same form control.
function ACS_getContainerClass(obj) {
    return $advjQuery(obj).closest(".CustomModal").parent().attr("class");
}

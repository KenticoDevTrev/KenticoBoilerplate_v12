<%@ Control Language="C#" AutoEventWireup="true" Inherits="Compiled_CMSModules_RelationshipsExtended_UI_UniGrid_UniGrid" %>
<%@ Register Src="~/CMSModules/RelationshipsExtended/UI/Pager/UIPager.ascx" TagPrefix="cms" TagName="UIPager" %>
<%@ Register Src="~/CMSModules/RelationshipsExtended/UI/UniGrid/Controls/AdvancedExport.ascx" TagPrefix="cms"  TagName="AdvancedExport" %>
<%@ Register Src="~/CMSModules/RelationshipsExtended/UI/UniGrid/Controls/MassActions.ascx" TagPrefix="cms" TagName="MassActions" %>

    ...
    public sealed class TextEditorViewModel : InlineEditorViewModel
    {
        ...
        public string Tools
        {
            get {
                ...
                return _Tools ?? "undo redo | formatselect | bold italic backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | help | tinyMceAttributionButton"; }
            set {
